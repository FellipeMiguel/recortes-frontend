...
interface NewCutPageHeaderProps {
  control: Control<CreateCutForm>;
  currentStatus: CreateCutForm["body"]["status"];
}
    ...
    <div className="flex justify-between items-center">
      ...
      <div className="flex items-center gap-4">
        <div className="relative flex items-center gap-2">
          ...
          {isTooltipVisible && (
            <div
              className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-3 py-1 bg-gray-800 text-white text-sm rounded-md shadow-lg transition-opacity duration-300"
              style={{ opacity: 1 }}
            >
